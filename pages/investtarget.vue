<template>
    <div>
        ...
        <form class="w-full px-10">
            <div class="mb-6">
                <label for="invest" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Invest</label>
            ...
            <div class="mb-6">
                <label for="return" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Return</label>
